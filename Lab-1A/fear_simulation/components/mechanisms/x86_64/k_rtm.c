...
#define nrn_init _nrn_init__k_rtm
#define _nrn_initial _nrn_initial__k_rtm
#define nrn_cur _nrn_cur__k_rtm
#define _nrn_current _nrn_current__k_rtm
#define nrn_jacob _nrn_jacob__k_rtm
#define nrn_state _nrn_state__k_rtm
#define _net_receive _net_receive__k_rtm 
#define rate rate__k_rtm 
#define states states__k_rtm 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_k_rtm", _hoc_setdata,
 "rate_k_rtm", _hoc_rate,
 0, 0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 k_rtm /home/fabric/work/CI-BioEng-Class/fear_simulation/components/mechanisms/k_rtm.mod\n");
...
static int  rate ( _threadargsprotocomma_ double _lv ) {
   ...
   tau = ( 1.0 - exp ( - _lv / 5.0 - 52.0 / 5.0 ) ) / ( 0.032 * _lv + 0.5 * ( 1.0 - exp ( - _lv / 5.0 - 52.0 / 5.0 ) ) * exp ( - _lv / 40.0 - 57.0 / 40.0 ) + 1.664 ) ;
     return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/fabric/work/CI-BioEng-Class/fear_simulation/components/mechanisms/k_rtm.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
